...
export const Education = () => {
    ...
    return (
        ...
        >
            ...
            {/* Tab Buttons */}
            <div className="flex bg-[rgba(3,0,20,0.8)] backdrop-blur-xl border border-[#7042f88b] rounded-full p-1.5 mb-16 shadow-[0_0_20px_rgba(112,66,248,0.2)] scrollbar-hide overflow-x-auto max-w-[95vw] md:max-w-full relative">
                <button
                    onClick={() => setActiveTab("experience")}
                    className="relative flex items-center gap-2 px-6 md:px-8 py-2.5 rounded-full font-medium whitespace-nowrap transition-colors duration-300 group"
                >
                    {activeTab === "experience" && (
                        <motion.div
                            layoutId="activeTab"
                            className="absolute inset-0 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-full shadow-[0_0_15px_rgba(112,66,248,0.5)]"
                            transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                        />
                    )}
                    <BriefcaseIcon className={`h-5 w-5 relative z-10 transition-colors duration-300 ${activeTab === "experience" ? "text-white" : "text-gray-400 group-hover:text-white"}`} />
                    <span className={`relative z-10 transition-colors duration-300 ${activeTab === "experience" ? "text-white" : "text-gray-400 group-hover:text-white"}`}>Experience</span>
                </button>
                <button
                ...
                >
                    ...
                    <AcademicCapIcon className={`h-5 w-5 relative z-10 transition-colors duration-300 ${activeTab === "education" ? "text-white" : "text-gray-400 group-hover:text-white"}`} />
                    <span className={`relative z-10 transition-colors duration-300 ${activeTab === "education" ? "text-white" : "text-gray-400 group-hover:text-white"}`}>Education</span>
                </button>
                <button
                ...
                >
                    ...
                    <TrophyIcon className={`h-5 w-5 relative z-10 transition-colors duration-300 ${activeTab === "certification" ? "text-white" : "text-gray-400 group-hover:text-white"}`} />
                    <span className={`relative z-10 transition-colors duration-300 ${activeTab === "certification" ? "text-white" : "text-gray-400 group-hover:text-white"}`}>Certification</span>
                </button>
            </div>
                ...
                <AnimatePresence mode="wait">
                    ...
                    {activeTab === "certification" && (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -10 }}
                            transition={{ duration: 0.3 }}
                            className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full px-10"
                        >
